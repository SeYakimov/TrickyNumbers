...
class PlayState extends State implements InputProcessor {
    ...
    PlayState(GameStateManager gsm, AssetManager manager, com.east71.trickynumbers.IActivityRequestHandler handler, Difficulty difficulty) {
        ...
        gButtons = new com.east71.trickynumbers.models.GameButton[numOfButtons];
        ...
        for (int i = 0; i < numOfButtons; i++){
            gButtons[i] = new com.east71.trickynumbers.models.GameButton("", myColor, (int) PADDING.x, PADDING_BOTTOM + i * (GAP + buttonHeight),
                w - (int) PADDING.x * 2, buttonHeight, normal);
        }

        btnGameOver = new com.east71.trickynumbers.models.TextButton("GAMEOVER", myColor, -w + (int) PADDING.y,
                PADDING_GAMEOVER + GAP * 2 + buttonHeightGameOver + buttonHeightScore, w - (int) PADDING.y * 2, buttonHeightGameOver, small);
        btnScore = new com.east71.trickynumbers.models.TextButton("", myColor, -w + (int) PADDING.y,
                PADDING_GAMEOVER + GAP + buttonHeightGameOver, w - (int) PADDING.y * 2, buttonHeightScore, big);
        btnHighScore = new com.east71.trickynumbers.models.TextButton("", myColor, -w + (int) PADDING.y,
    ...
    private boolean isRightAnswer(com.east71.trickynumbers.models.GameButton button){
    ...
    private void check(com.east71.trickynumbers.models.GameButton btn) {
    ...
    private void changeButtonsColor(){
        myColor = com.east71.trickynumbers.models.RColor.getColor();
        for (int i = 0; i < numOfButtons; i++){
